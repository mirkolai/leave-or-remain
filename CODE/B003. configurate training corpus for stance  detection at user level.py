...
for tweet in tweets:
    ...
    cur.execute(" INSERT INTO `sample_1_training_corpus_for_user`"
                " (`id_1`, `text_1`,`id_2`, `text_2`,`id_3`, `text_3`, `phase`, `stance`) "
                " VALUES  "
                " (%s,%s,%s,%s,%s,%s,%s,%s) ",
                (tweet_id_1, tweet_text_1,tweet_id_2, tweet_text_2,tweet_id_3, tweet_text_3, phase,stance))
